...
import { PrdouctsFullInfoSlider } from "../../../components/common/Sliders/index.js";
...
const ProductsFullInfo = ({ productFullInfo }) => {
  const dispatch = useDispatch();
  return (
    <>
      <Grid className="h-screen w-[50%]" xs={12} md={6} sx={{ mt: "50px" }}>
...
export default ProductsFullInfo;
